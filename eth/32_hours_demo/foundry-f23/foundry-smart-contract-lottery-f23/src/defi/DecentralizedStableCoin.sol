...
// 这是一个被认为是外生的、去中心化的、锚定（挂钩）的、加密抵押的低波动率币，也就是稳定币。
 ...
 * 这个合约是由DSCEngine拥有的。它是一个ERC20代币，可以由DSCEngine智能合约进行铸造和销毁。
 */
contract DecentralizedStableCoin is ERC20Burnable, Ownable {
    ...
    */
    ...
    // 这个 burn 用于销毁代币，只有合约的拥有者才能调用这个函数 
    ...
    // 这个 mint 用于铸造代币，只有合约的拥有者才能调用这个函数 
    function mint(
        address _to,
        uint256 _amount
