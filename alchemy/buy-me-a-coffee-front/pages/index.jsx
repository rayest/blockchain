...
export default function Home() {
  ...
  const buyCoffee = async () => {
    try {
      ...
      if (ethereum) {
        ...
        // here we are calling the buyCoffee function from our contract
        const coffeeTxn = await buyMeACoffee.buyCoffee(
          name ? name : "anon",
          message ? message : "Enjoy your coffee!",
          { value: ethers.utils.parseEther("0.001") } // todo the value should come from the user input and check if it's right
        );
  ...
  // UseEffect hook to run the wallet connection logic
  useEffect(() => {
    let buyMeACoffee;
    isWalletConnected();
    getMemos();
